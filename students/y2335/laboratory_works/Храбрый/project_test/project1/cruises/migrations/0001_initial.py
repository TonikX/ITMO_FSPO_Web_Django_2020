    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cruis', models.ManyToManyField(to='cruises.Cruis')),
                ('motorship', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='cruises.motorship')),
            ],
        ),
        migrations.CreateModel(
            name='Ticket',
            fields=[
                ...
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='cruises.ticketcategory')),
                ('tour', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='cruises.tour')),
            ],
        ),
        migrations.CreateModel(
            name='Sailor',
            fields=[
                ...
                ('team', models.ManyToManyField(to='cruises.MotorshipTeam')),
            ],
        ),
        migrations.AddField(
            model_name='motorship',
            name='team',
            field=models.ManyToManyField(to='cruises.MotorshipTeam'),
        ),
        migrations.CreateModel(
            name='CruisRoute',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cruis', models.ManyToManyField(to='cruises.Cruis')),
                ('route', models.ManyToManyField(to='cruises.Route')),
            ],
        ),
    ]
